<template>
  <div class="relative bg-skin-fill max-w-4xl mx-auto overflow-hidden sm:rounded-2xl">
    ...
    />
    <div class="absolute inset-0 bg-gradient-to-br from-skin-hue via-skin-hue to-transparent opacity-90" />
    <div class="relative max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
      ...
      <p class="mt-4 text-lg leading-6 text-skin-muted">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias aliquid aperiam beatae consequuntur cum debitis
        doloribus excepturi fugiat harum hic molestiae.
      </p>
